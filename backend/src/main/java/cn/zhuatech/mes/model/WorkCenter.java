...
@Entity @Table(name="mes_work_center") public class WorkCenter extends BaseEntity {
    ...
    protected WorkCenter(){} public WorkCenter(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
